...
import example from "../../public/usama3-removebg-preview.png";
import "./hero.css";
const Hero = () => {
  const whatsappNumber = "+8615900940221"; // Define the whatsappNumber variable
  useEffect(() => {
    ...
    <main>
      <section id="home" className="home">
        <div className="home-content">
          ...
          <h5>Email:</h5>
<a href="mailto:usamakhattak2003@gmail.com">
usamakhattak2003@gmail.com</a>
</div>
          
          </div>

          <br />
          <div className="add">  Address:1234 Tech Avenue, Suite 567, New York, NY 10001, USA</div>
...
href="https://www.linkedin.com/search/results/all/?fetchDeterministicClustersOnly=true&heroEntityKey=urn%3Ali%3Afsd_profile%3AACoAAElt-K8Br21Cu7d924LEsj2IHF4yC89iA4k&keywords=abdul%20basit%20mujeeb&origin=RICH_QUERY_TYPEAHEAD_HISTORY&position=0&searchId=51e3504f-a9d3-41e0-96a0-">             
          ...
          <div className="social-icons ">
            ...
            <a href="https://www.linkedin.com/search/results/all/?fetchDeterministicClustersOnly=true&heroEntityKey=urn%3Ali%3Afsd_profile%3AACoAAElt-K8Br21Cu7d924LEsj2IHF4yC89iA4k&keywords=abdul%20basit%20mujeeb&origin=RICH_QUERY_TYPEAHEAD_HISTORY&position=0&searchId=51e3504f-a9d3-41e0-96a0-">
              <FaLinkedin />
            </a>
            <a
              href={`https://wa.me/${whatsappNumber}`}
        ...
        <div className="home-image">
          <div className="image-box">
            <Image src={example} alt="alishba" height={290} width={380} />
          </div>
